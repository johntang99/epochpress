...
const defaultData: LandingPageData = {
  ...
  services: [
    ...
    { name: 'Magazine Printing', slug: '/magazine-printing-new-jersey', description: 'Saddle-stitch and perfect-bound magazines. Full color, premium paper options. G7 color certified.', icon: 'BookOpen' },
    { name: 'Book Printing', slug: '/book-printing-new-jersey', description: 'Softcover and hardcover book production. POD from 1 copy to high-volume offset runs.', icon: 'BookMarked' },
    { name: 'Marketing Print', slug: '/marketing-printing-new-jersey', description: 'Flyers, brochures, postcards, and direct mail. USPS certified mailer.', icon: 'FileText' },
    { name: 'Menu Printing', slug: '/menu-printing-new-jersey', description: 'Restaurant menus — laminated, folded, multi-page. Durable wipe-clean finishes.', icon: 'UtensilsCrossed' },
