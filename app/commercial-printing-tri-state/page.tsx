...
export const metadata: Metadata = {
  title: 'Tri-State Commercial Printing',
  description: 'Tri-state commercial printing serving NJ, NY & CT. Newspapers, magazines, books, marketing materials. Two facilities, fast turnaround. Request a quote.',
  alternates: { canonical: '/commercial-printing-tri-state' },
};
...
const defaultData: LandingPageData = {
  hero: {
    h1: 'Commercial Printing for the Tri-State Area',
    subheading: 'Epoch Press — Full-Service Printing for Publishers, Brands & Agencies',
    intro: 'Epoch Press has served publishers, businesses, and organizations across the tri-state area for over 25 years. Our two production facilities in Wayne, NJ and Middletown, NY give us the geographic reach and capacity runs advanced offset and digital presses capable of printing newspapers, magazines, books, catalogs, and marketing materials at any volume — with turnaround times that keep your deadlines on track.',
  },
  services: [
...
export default async function CommercialPrintingTriStatePage() {
  const siteId = await getRequestSiteId();
  const dbContent = await loadPageContent<LandingPageData>('commercial-printing-tri-state', 'en', siteId);
    ...
    <>
      ...
      <section className="bg-navy-gradient text-white pt-36 md:pt-40 pb-16">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-amber-400 font-medium mb-4 tracking-wide uppercase text-sm">Tri-State Commercial Printer</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            From short-run digital to high-volume offset, Epoch Press produces a full range of commercial print products for tri-state businesses and beyond.
          </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Industries We Serve Across the Tri-State</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-center text-gray-500 mt-8">
            Also serving clients in <Link href="/commercial-printing-new-jersey" className="text-amber-600 font-medium hover:underline">New Jersey</Link> and <Link href="/commercial-printing-new-york" className="text-amber-600 font-medium hover:underline">New York</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Why Tri-State Businesses Choose Epoch Press</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">Tri-State Printing — Common Questions</h2>
