...
export const metadata: Metadata = {
  title: 'Commercial Printing in New York',
  description: 'Full-service commercial printing in New York. Newspapers, magazines, books, marketing materials. Two NJ/NY facilities, fast turnaround. Request a quote.',
  alternates: { canonical: '/commercial-printing-new-york' },
};
...
const defaultData: LandingPageData = {
  hero: {
    h1: 'Commercial Printing Services in New York',
    subheading: 'Epoch Press — Full-Service Printing for Publishers, Brands & Agencies',
    intro: 'Epoch Press has served New York publishers, businesses, and organizations for over 25 years. Our Middletown, NY production facility runs advanced offset and digital presses capable of printing newspapers, magazines, books, catalogs, and marketing materials at any volume — with turnaround times that keep your deadlines on track.',
  },
  services: [
    ...
    { name: 'Magazine Printing', slug: '/magazine-printing-new-york', description: 'Saddle-stitch and perfect-bound magazines. Full color, premium paper options. G7 color certified.', icon: 'BookOpen' },
    { name: 'Book Printing', slug: '/book-printing-new-york', description: 'Softcover and hardcover book production. POD from 1 copy to high-volume offset runs.', icon: 'BookMarked' },
    { name: 'Marketing Print', slug: '/marketing-printing-new-york', description: 'Flyers, brochures, postcards, and direct mail. USPS certified mailer.', icon: 'FileText' },
    { name: 'Menu Printing', slug: '/menu-printing-new-york', description: 'Restaurant menus — laminated, folded, multi-page. Durable wipe-clean finishes.', icon: 'UtensilsCrossed' },
  ...
  faq: [
    ...
    { question: 'Do you serve all of New York?', answer: 'Yes. Our Middletown, NY facility serves clients throughout New York — from the NYC metro area and Hudson Valley to upstate. We also serve New Jersey from our Wayne, NJ production facility.' },
...
export default async function CommercialPrintingNYPage() {
  const siteId = await getRequestSiteId();
  const dbContent = await loadPageContent<LandingPageData>('commercial-printing-new-york', 'en', siteId);
  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            From short-run digital to high-volume offset, Epoch Press produces a full range of commercial print products for New York businesses and beyond.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {data.services.map((service) => (
              ...
              >
                {(() => { const Icon = serviceIconMap[service.name] || Printer; return (<div className="w-12 h-12 bg-amber-50 rounded-lg flex items-center justify-center mb-4"><Icon className="w-6 h-6 text-amber-600" /></div>); })()}<h3 className="font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors">{service.name}</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Industries We Serve in New York</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-center text-gray-500 mt-8">
            Also serving clients in <Link href="/commercial-printing-new-jersey" className="text-amber-600 font-medium hover:underline">New Jersey</Link> and the <Link href="/commercial-printing-tri-state" className="text-amber-600 font-medium hover:underline">tri-state area</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Why New York Businesses Choose Epoch Press</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">Commercial Printing in NY — Common Questions</h2>
